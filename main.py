...
def main():
    ...
    user_keywords = input("Введите ключевые слова для вывода вакансий через пробел").lower().split()
    ...
    try:
        with psycopg2.connect(**params) as conn:
            with conn.cursor() as cur:
                ...
                print("Вакансии, в названии которых содержатся переданные в метод слова")
